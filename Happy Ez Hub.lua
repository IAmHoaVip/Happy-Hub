...
SP = "Default"
elseif SelectMaterial == "Giọt Huyền Bí " then
MMon = "Water Fighter"
...
elseif SelectMaterial == "Da thú " then
if First_Sea then
MMon = "Brute"
...
elseif SelectMaterial == "Kim loại phế liệu " then
if First_Sea then
MMon = "Brute"
MPos = CFrame.new(-1145,15,4350)
SP = "Default"
...
SP = "Default"
elseif SelectMaterial == "Ca cao gợi cảm " then
...
spawn(function()
    ...
    if First_Sea then
		tableBoss = {"Vua khỉ đột ","Bobby ","Yeti ","Thủ lĩnh đám đông ","Phó Đô đốc ","cai ngục ","Trưởng cai ngục ","Thiên nga ","Đô đốc magma ","Chúa tể người cá ","Wysper ","Thần sấm ","Cyborg","Saber Expert"}
	elseif Second_Sea then
...
local Chips = {"Ngọn lửa ","Bang ","Quake","Light","Dark","Spider","Rumble","Magma","Buddha","Sand","Phoenix","Dough"}
